      ...
      <div class="el__overflow">
        <div class="el__inner">
          ...
          <div class="el__content">
            <div class="el__text">Sequences and Series</div>
    ...
    <div class="el">
      <div class="el__overflow">
        <div class="el__inner">
          ...
          <div class="el__content">
            <div class="el__text">Differentiation</div>
            <div class="el__close-btn"></div>
          </div>
        </div>
      </div>
    ...
    <div class="el">
      <div class="el__overflow">
        <div class="el__inner">
          ...
          <div class="el__content">
            <div class="el__text">Integration</div>
            <div class="el__close-btn"></div>
          </div>
        </div>
      </div>
    ...
    <div class="el">
      <div class="el__overflow">
        <div class="el__inner">
          ...
          <div class="el__content">
            <div class="el__text">Cool Stuff</div>
            <div class="el__close-btn"></div>
          </div>
        </div>
      </div>
